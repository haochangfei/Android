...
import cn.edu.bzu.hcf.myboxuegu.adapter.ExercisesAdapter;
        ...
        for(int i = 0; i < 10; ++i){
            ...
            switch (i){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    bean.title = "第 4 章 数字存储";
                    bean.content = "共计5题";
                    bean.background = (R.drawable.exercises_bg_4);
                    break;
                case 4:
                    bean.title = "第 5 章 SQLite数据库";
                    bean.content = "共计5题";
                    bean.background = (R.drawable.exercises_bg_1);
                    break;
                case 5:
                    bean.title = "第 6 章 广播接受者";
                    bean.content = "共计5题";
                    bean.background = (R.drawable.exercises_bg_2);
                    break;
                case 6:
